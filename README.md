...
🎓 Computer Science & Engineering graduate from **[NIT Allahabad](http://www.mnnit.ac.in)**, passionate about solving real-world problems through **scalable** and **intelligent software solutions**. Whether it's building robust backend systems, optimizing performance, or integrating AI-driven capabilities, I thrive on crafting impactful technology. 🚀
...
- **AWS (Lambda, S3, ECS, DynamoDB, Bedrock, Athena)**

### 🔹 DevOps & Automation
- **Docker, CI/CD Pipelines, Kubernetes**
- **AWS Step Functions, Selenium, Git**

### 🔹 AI & Data Processing
- **AWS Glue (ETL), Amazon Athena**
- **ML models for automation, document processing & fraud detection**

### 🔹 Security & Performance
- **Cryptographic techniques for secure transactions**
- **Load balancing with AWS Lambda**
...
## 🚀 Beyond Code
I love decoding user behavior to build **intuitive applications** and streamline workflows. Constantly exploring **cloud computing, AI-driven architectures, and advanced JavaScript frameworks** to stay ahead of the curve.

💡 **Fun Fact:** _The best applications don’t just perform well—they make users feel empowered and engaged._
